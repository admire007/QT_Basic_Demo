...
public:
    ...
    void setupUi(QWidget *Widget)
    {
        ...
        web_widget = new QWebEngineView(Widget);
        web_widget->setObjectName(QString::fromUtf8("web_widget"));

        horizontalLayout_2->addWidget(web_widget);

        web_widget2 = new CWebView(Widget);
        web_widget2->setObjectName(QString::fromUtf8("web_widget2"));

        horizontalLayout_2->addWidget(web_widget2);
